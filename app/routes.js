module.exports = function(app, passport, db) {
    ...
    // normal routes ===============================================================
        ...
        // PROFILE SECTION =========================
        app.get('/bowl', isLoggedIn, function(req, res) {
            db.collection('messages').find().toArray((err, result) => {
                if (err) return console.log(err)
                res.render('createBowl.ejs', {
                user : req.user,
                messages: result
                })
            })
    ...
    // create bowl routes ===============================================================
        ...
        app.get('/recipes', function(req,res){
            db.collection('bowl').find().toArray((err, bowl) =>{
                if (err) return console.log(err)
    ...
    // =============================================================================
        ...
        // locally --------------------------------
            ...
            app.post('/login', passport.authenticate('local-login', {
                successRedirect : '/bowl', // redirect to the secure recipes section
